    ...
    <nav class="sidebar-nav">
      <ul>
        <li class="nav-item nav-item-has-children">
          <a href="#0" class="<?php echo $page == 'index.php' ? '' : 'collapsed' ?>" data-bs-toggle="collapse" data-bs-target="#ddmenu_1" aria-controls="ddmenu_1" aria-expanded="false" aria-label="Toggle navigation">
            <span class="icon">
          ...
          <ul id="ddmenu_1" class="collapse  dropdown-nav <?php echo $page == 'index.php' ? 'show' : '' ?>">
            <li>
        ...
        <li class="nav-item nav-item-has-children">
          <a href="#0" class="<?php echo $page == 'profile.php' ? '' : 'collapsed' ?>" data-bs-toggle="collapse" data-bs-target="#ddmenu_2" aria-controls="ddmenu_2" aria-expanded="false" aria-label="Toggle navigation">
            <span class="icon">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <ul id="ddmenu_2" class="collapse dropdown-nav <?php echo $page == 'profile.php' ? 'show' : '' ?>">
            <li>
              <a href="profile.php" class="<?php echo $page == 'profile.php' ? 'active' : '' ?>"> Profile </a>
            </li>

          </ul>
        </li>
        <li class="nav-item nav-item-has-children">
          <a href="#0" class="<?php echo $page == 'post.php'  ? '' : 'collapsed' ?>" data-bs-toggle="collapse" data-bs-target="#ddmenu_5" aria-controls="ddmenu_5" aria-expanded="false" aria-label="Toggle navigation">
            <span class="icon">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <ul id="ddmenu_5" class="collapse dropdown-nav <?php echo $page == 'post.php' ? 'show' : '' ?> <?php echo $page == 'region-category.php' ? 'show' : '' ?>">
            <li>
              <a href="post.php" class="<?php echo $page == 'post.php' ? 'active' : '' ?>"> Post</a>
            </li>
            <li>
              <a href="region-category.php" class="<?php echo $page == 'region-category.php' ? 'active' : '' ?>"> Places</a>
            </li>
          </ul>
        </li>
        ...
        <li class="nav-item <?php echo $page == 'image.php' ? 'active' : '' ?>">
          <a href="image.php">
            <span class="icon">
        ...
        <li class="nav-item <?php echo $page == 'notification.php' ? 'active' : '' ?>">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-5 col-md-5 col-6">
            <div class="header-left d-flex align-items-center">
              ...
              <div class="header-search d-none d-md-flex">
                ...
                <form action="<?php if ($page == 'region-category.php') { ?> region-category.php <?php }else if($page == 'image.php'){ ?> image.php <?php } ?>" method="post" <?php if ($page == 'region-category.php') { ?> style="display: block;" <?php }else if($page == 'image.php'){ ?> style="display: block;" <?php } else { ?> style="display: none;" <?php } ?>>
                  <input name="_token" type="hidden" value="<?php echo $_SESSION['_token']; ?>">
                  <input type="text" placeholder="Search..." name="search" />
                  <button type="button" class="lni lni-search-alt"></i></button>
                </form>
              </div>
            </div>
          </div>
          <div class="col-lg-7 col-md-7 col-6">
            ...
            <?php
                $stmtReport = $pdo->prepare("SELECT * FROM reports WHERE read_as='0' ");
                $stmtReport->execute();
                      ...
                      <li>
                        <a href="notification.php">
                          <div class="image warning-bg">
                            <span style="display:flex;justify-content:center;padding-top:5px;font-weight:600"><?php echo substr($value['username'], 0, 1) ?></span>
                          </div>
                          <div class="content">
                            <h6>
