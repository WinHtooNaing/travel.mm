...
<?php 
    if($_POST){
        ...
        empty($_FILES['image1']) || empty($_POST['description2']) || empty($_FILES['image2']) ){
            ...
            $file1 = 'admin/post_image/'.($_FILES['image1']['name']);
            $file2 = 'admin/post_image/'.($_FILES['image2']['name']);
            ...
            $imageType2 != 'png' && $imageType2 != 'jpg' && $imageType2 != 'jpeg'){
                ...
                if($result){
                    echo "<script>alert('successfully added');window.location.href='user-post.php';</script>";
                }
            }
        }
    }
...
<section class="tab-components">
    <div class="container-fluid">
        ...
        <div class="title-wrapper pt-30">
            <div class="row align-items-center" style="width:90%;margin-left:5%">
                <div class="col-md-6">
                    <div class="title">
                        <h2>Post</h2>
                    </div>
            ...
            <div class="row ">
                <div class="col-lg-8 container ">
                    ...
                    <div class="card-style mb-30 ">
                        ...
                        <form action="create-user-post.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="input-style-1" style="display:flex;justify-content:space-between">
                                <a href="user-post.php" class="main-btn warning-btn btn-hover">Back</a>
